...
if __name__ == "__main__":
    ...
    plt.plot(x, y, 'b-', x, y, 'go', linewidth=2, markersize=8)
    ...
    plt.subplot(121)#多个图例编号
    plt.hist(y, bins=bins,histtype='barstacked', range=r, color='b', alpha=0.8, normed=True)
    t = np.arange(0, mx+1)
    plt.plot(t, p.pmf(t), 'ro-', lw=2,label='1')
    plt.grid(True)
